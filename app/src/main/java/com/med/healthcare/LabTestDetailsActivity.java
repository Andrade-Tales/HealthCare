...
public class LabTestDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edDetalhes = findViewById(R.id.editTextLTDMultiline);
        ...
        botaoLTDVoltar.setOnClickListener(view -> startActivity(new Intent(LabTestDetailsActivity.this, LabTestActivity.class)));
